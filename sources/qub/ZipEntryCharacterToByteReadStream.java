...
public class ZipEntryCharacterToByteReadStream implements CharacterToByteReadStream
{
    private final java.util.zip.ZipEntry zipEntry;
    private final CharacterToByteReadStream readStream;
    private boolean disposed;

    private ZipEntryCharacterToByteReadStream(java.util.zip.ZipEntry zipEntry, CharacterToByteReadStream readStream)
    {
    ...
    public static ZipEntryCharacterToByteReadStream create(java.util.zip.ZipEntry zipEntry, CharacterToByteReadStream readStream)
    {
        return new ZipEntryCharacterToByteReadStream(zipEntry, readStream);
    }
    ...
    @Override
    public ZipEntryCharacterToByteReadStream setCharacterEncoding(CharacterEncoding characterEncoding)
    {
        PreCondition.assertNotDisposed(this, "this");
