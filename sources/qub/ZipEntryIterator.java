...
public class ZipEntryIterator implements Iterator<ZipEntryCharacterToByteReadStream>, Disposable
{
    ...
    private ZipEntryCharacterToByteReadStream current;
    ...
    @Override
    public ZipEntryCharacterToByteReadStream getCurrent()
    {
    ...
    public boolean next()
    {
        ...
        else
        {
            ...
            this.current = ZipEntryCharacterToByteReadStream.create(javaZipEntry, ignoreDisposeReadStream);
        }
