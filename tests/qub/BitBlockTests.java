...
public class BitBlockTests
{
    ...
    {
        runner.testGroup(BitBlock.class, () ->
        {
            runner.testGroup("fromBitCount(long)", () ->
            {
                ...
                {
                    final BitBlock block = BitBlock.fromBitCount(7);
                    test.assertNotNull(block);
                ...
                {
                    final BitBlock block = BitBlock.fromBitCount(8);
                    test.assertNotNull(block);
                ...
                {
                    final BitBlock block = BitBlock.fromBitCount(9);
                    test.assertNotNull(block);
                ...
                {
                    final BitBlock block = BitBlock.fromBitCount(100);
                    test.assertNotNull(block);
                ...
                {
                    test.assertThrows(
                        () -> BitBlock.fromBitCount(68719476705L),
                ...
                {
                    test.assertThrows(
                        () -> BitBlock.fromBitCount(68719476706L),
            ...
            runner.testGroup("getBit(long)", () ->
            {
                ...
                {
                    final BitBlock block = BitBlock.fromBitCount(10);
                    test.assertThrows(
                        () -> block.getBit(-1),
            ...
            runner.testGroup("setAllBits(int)", () ->
            {
                ...
                {
                    final BitBlock block = BitBlock.fromBitCount(3);
                    test.assertThrows(
                        () -> block.setAllBits(-1),
            ...
            runner.testGroup("toString()", () ->
            {
                ...
                {
                    final BitBlock block = BitBlock.fromBitCount(5);
                ...
                {
                    final BitBlock block = BitBlock.fromBitCount(6);
                    block.setAllBits(1);
            ...
            runner.testGroup("equals(Object)", () ->
            {
                ...
                {
                    final BitBlock block = BitBlock.fromBitCount(5);
                    test.assertTrue(block.equals((Object)BitBlock.fromBitCount(5)));
                });

                runner.test("with different bit count but same block", (Test test) ->
                {
                    final BitBlock block = BitBlock.fromBitCount(5);
                    final BitBlock otherBits = BitBlock.fromBitCount(6);
                ...
                {
                    final BitBlock block = BitBlock.fromBitCount(5);
                    final BitBlock otherBits = BitBlock.fromBitCount(5);
                    otherBits.setBit(0, 1);
                    test.assertFalse(block.equals((Object)otherBits));
                });
            });

            runner.testGroup("equals(BitBlock)", () ->
            {
                runner.test("with null", (Test test) ->
                {
                    final BitBlock block = BitBlock.fromBitCount(5);
                    test.assertFalse(block.equals((BitBlock)null));
                });
                ...
                {
                    final BitBlock block = BitBlock.fromBitCount(5);
                    test.assertTrue(block.equals(BitBlock.fromBitCount(5)));
                });
