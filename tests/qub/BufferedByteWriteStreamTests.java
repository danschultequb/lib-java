    ...
    static void test(TestRunner runner)
    {
        runner.testGroup(BufferedByteWriteStream.class, () ->
        {
            runner.testGroup("constructor(ByteWriteStream)", () ->
            {
                ...
                {
                    test.assertThrows(() -> BufferedByteWriteStream.create(null), new PreConditionFailure("byteWriteStream cannot be null."));
                });
                ...
                runner.test("with disposed stream", (Test test) ->
                {
                    ...
                    final BufferedByteWriteStream byteWriteStream = BufferedByteWriteStream.create(innerStream);
            ...
            runner.testGroup("constructor(ByteWriteStream,int)", () ->
            {
                runner.test("with null stream", (Test test) ->
                {
                    test.assertThrows(() -> BufferedByteWriteStream.create(null, 5), new PreConditionFailure("byteWriteStream cannot be null."));
                });

                runner.test("with negative buffer size", (Test test) ->
                {
                    test.assertThrows(() -> BufferedByteWriteStream.create(null, -1), new PreConditionFailure("byteWriteStream cannot be null."));
                });

                runner.test("with zero buffer size", (Test test) ->
                {
                    test.assertThrows(() -> BufferedByteWriteStream.create(null, 0), new PreConditionFailure("byteWriteStream cannot be null."));
                });
                ...
                runner.test("with disposed stream", (Test test) ->
                {
                    final InMemoryByteStream innerStream = InMemoryByteStream.create();
                    innerStream.dispose().await();
                    final BufferedByteWriteStream byteWriteStream = BufferedByteWriteStream.create(innerStream, 5);
                    test.assertTrue(byteWriteStream.isDisposed());
                    test.assertEqual(0, byteWriteStream.getBufferCapacity());
                    test.assertEqual(0, byteWriteStream.getBufferByteCount());
                ...
                {
                    final InMemoryByteStream innerStream = InMemoryByteStream.create();
                    final BufferedByteWriteStream byteWriteStream = BufferedByteWriteStream.create(innerStream, 5, 20);
                    test.assertFalse(byteWriteStream.isDisposed());
            ...
            runner.testGroup("constructor(ByteWriteStream,int,int)", () ->
            {
                runner.test("with null stream", (Test test) ->
                {
                    test.assertThrows(() -> BufferedByteWriteStream.create(null, 5, 10), new PreConditionFailure("byteWriteStream cannot be null."));
                });

                runner.test("with negative initial buffer size", (Test test) ->
                {
                    test.assertThrows(() -> BufferedByteWriteStream.create(InMemoryByteStream.create(), -1, 10), new PreConditionFailure("initialBufferSize (-1) must be greater than or equal to 1."));
                });

                runner.test("with zero initial buffer size", (Test test) ->
                {
                    test.assertThrows(() -> BufferedByteWriteStream.create(InMemoryByteStream.create(), 0, 10), new PreConditionFailure("initialBufferSize (0) must be greater than or equal to 1."));
                });

                runner.test("with negative maximum buffer size", (Test test) ->
                {
                    test.assertThrows(() -> BufferedByteWriteStream.create(InMemoryByteStream.create(), 10, -1), new PreConditionFailure("maximumBufferSize (-1) must be greater than or equal to 10."));
                });

                runner.test("with zero maximum buffer size", (Test test) ->
                {
                    test.assertThrows(() -> BufferedByteWriteStream.create(InMemoryByteStream.create(), 10, 0), new PreConditionFailure("maximumBufferSize (0) must be greater than or equal to 10."));
                });

                runner.test("with positive maximum buffer size less than initial buffer size", (Test test) ->
                {
                    test.assertThrows(() -> BufferedByteWriteStream.create(InMemoryByteStream.create(), 10, 9), new PreConditionFailure("maximumBufferSize (9) must be greater than or equal to 10."));
                });

                runner.test("with maximum buffer size equal to initial buffer size", (Test test) ->
                {
                    final InMemoryByteStream innerStream = InMemoryByteStream.create();
                    final BufferedByteWriteStream byteWriteStream = BufferedByteWriteStream.create(innerStream, 5, 5);
                    test.assertFalse(byteWriteStream.isDisposed());
                    test.assertEqual(5, byteWriteStream.getBufferCapacity());
                    test.assertEqual(0, byteWriteStream.getBufferByteCount());
                    test.assertEqual(5, byteWriteStream.getMaximumBufferSize());
                ...
                runner.test("with disposed stream", (Test test) ->
                {
                    final InMemoryByteStream innerStream = InMemoryByteStream.create();
                    innerStream.dispose().await();
                    final BufferedByteWriteStream byteWriteStream = BufferedByteWriteStream.create(innerStream, 5, 10);
                    test.assertTrue(byteWriteStream.isDisposed());
                    test.assertEqual(0, byteWriteStream.getBufferCapacity());
                    test.assertEqual(0, byteWriteStream.getBufferByteCount());
            ...
            runner.testGroup("write(byte[],int,int)", () ->
            {
                ...
                {
                    final InMemoryByteStream innerStream = InMemoryByteStream.create();
                    final BufferedByteWriteStream byteWriteStream = BufferedByteWriteStream.create(innerStream, 1, 20);
                ...
                {
                    final InMemoryByteStream innerStream = InMemoryByteStream.create();
                    final BufferedByteWriteStream byteWriteStream = BufferedByteWriteStream.create(innerStream, 3, 20);
                    test.assertEqual(3, byteWriteStream.write(new byte[] { 1, 2, 3 }).await());
                ...
                {
                    final InMemoryByteStream innerStream = InMemoryByteStream.create();
                    final ThrottledByteWriteStream throttledByteWriteStream = ThrottledByteWriteStream.create(innerStream, 1);
                    final BufferedByteWriteStream byteWriteStream = BufferedByteWriteStream.create(throttledByteWriteStream, 3);
                    test.assertEqual(3, byteWriteStream.write(new byte[] { 1, 2, 3, 4, 5 }).await());
