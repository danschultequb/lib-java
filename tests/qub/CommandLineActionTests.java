    ...
    static void test(TestRunner runner)
    {
        ...
        runner.testGroup(CommandLineAction.class, () ->
        {
            runner.testGroup("constructor()", () ->
            {
                ...
                {
                    test.assertThrows(() -> new CommandLineAction(null, (Process process) -> {}),
                        new PreConditionFailure("name cannot be null."));
                });

                runner.test("with empty name", (Test test) ->
                {
                    test.assertThrows(() -> new CommandLineAction("", (Process process) -> {}),
                        new PreConditionFailure("name cannot be empty."));
                });

                runner.test("with non-empty name", (Test test) ->
                {
                    final CommandLineAction action = new CommandLineAction("hello", (Process process) -> {});
                ...
                {
                    test.assertThrows(() -> new CommandLineAction("hello", null),
            ...
            runner.testGroup("addAlias(String)", () ->
            {
                ...
                runner.test("with alias already in use as a different action's name", (Test test) ->
                {
                    ...
                    final CommandLineAction action1 = actions.addAction("hello", (Process process) -> {});
                    final CommandLineAction action2 = actions.addAction("there", (Process process) -> {});
            ...
            runner.testGroup("run(Process)", () ->
            {
                ...
                runner.test("with non-null", (Test test) ->
                {
                    ...
                    final CommandLineAction action = new CommandLineAction("hello", (Process process) -> { value.increment(); });
