...
public interface CommandLineParameterTests
{
    static void test(TestRunner runner)
    {
        runner.testGroup(CommandLineParameter.class, () ->
        {
            runner.testGroup("constructor()", () ->
            {
                ...
                {
                    test.assertThrows(() -> new CommandLineParameter<>(null, null, Result::success),
                        new PreConditionFailure("name cannot be null."));
                });

                runner.test("with empty name", (Test test) ->
                {
                    test.assertThrows(() -> new CommandLineParameter<>("", null, Result::success),
                ...
                {
                    test.assertThrows(() -> new CommandLineParameter<>("fakeName", -1, Result::success),
                ...
                {
                    final CommandLineParameter<String> parameter = new CommandLineParameter<>("fakeName", 3, Result::success);
                    test.assertNotNull(parameter);
                    test.assertEqual("fakeName", parameter.getName());
                    test.assertEqual(Iterable.create(), parameter.getAliases());
                    test.assertNull(parameter.getDescription());
            ...
            runner.testGroup("setDescription(String)", () ->
            {
                ...
                {
                    final CommandLineParameter<String> parameter = new CommandLineParameter<>("fakeName", null, Result::success);
                    test.assertSame(parameter, parameter.setDescription(null));
                    test.assertNull(parameter.getDescription());
                });
            ...
            runner.testGroup("getValue()", () ->
            {
                ...
                {
                    final CommandLineParameter<String> parameter = new CommandLineParameter<>("fakeName", null, Result::success);
                    test.assertThrows(parameter::getValue,
                ...
                runner.test("with non-null index and argument with matching position", (Test test) ->
                {
                    ...
                    test.assertEqual("spices", parameter.getValue().await());
                });
            ...
            runner.testGroup("removeValue()", () ->
            {
                ...
                {
                    final CommandLineParameter<String> parameter = new CommandLineParameter<>("fakeName", null, Result::success);
                    test.assertThrows(parameter::removeValue,
                        new PreConditionFailure("getArguments() cannot be null."));
                });
