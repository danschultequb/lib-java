    ...
    static void test(TestRunner runner)
    {
        runner.testGroup(DataSize.class, () ->
        {
            ...
            runner.testGroup("convertTo(DataSizeUnit)", () ->
            {
                ...
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Yobibytes,           0.0000000000000008881784197001252);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Zebibytes,           0.0000000000009094947017729282);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Exbibytes,           0.0000000009313225746154785);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Pebibytes,           0.00000095367431640625);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Tebibytes,           0.0009765625);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Gibibytes,           1.0);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Mebibytes,        1024.0);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Kibibytes,     1048576.0);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Yobibits,            0.000000000000007105427357601002);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Zebibits,            0.000000000007275957614183426);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Exbibits,            0.000000007450580596923828);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Pebibits,            0.00000762939453125);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Tebibits,            0.0078125);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Gibibits,            8.0);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Mebibits,         8192.0);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Kibibits,      8388608.0);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Yottabytes,          0.000000000000001073741824);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Zettabytes,          0.000000000001073741824);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Exabytes,            0.000000001073741824);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Petabytes,           0.000001073741824);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Terabytes,           0.001073741824);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Gigabytes,           1.073741824);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Megabytes,        1073.741824);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Kilobytes,     1073741.824);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Bytes,      1073741824.0);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Yottabits,           0.000000000000008589934592);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Zettabits,           0.000000000008589934592);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Exabits,             0.000000008589934592);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Petabits,            0.000008589934592);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Terabits,            0.008589934592);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Gigabits,            8.589934592);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Megabits,         8589.934592);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Kilobits,      8589934.592);
                convertToTest.run(DataSize.gibibytes(1), DataSizeUnit.Bits,       8589934592.0);

                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Yobibytes,        0.0000000000000000008673617379884035);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Zebibytes,        0.0000000000000008881784197001252);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Exbibytes,        0.0000000000009094947017729282);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Pebibytes,        0.0000000009313225746154785);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Tebibytes,        0.00000095367431640625);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Gibibytes,        0.0009765625);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Mebibytes,        1.0);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Kibibytes,     1024.0);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Yobibits,         0.000000000000000006938893903907228);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Zebibits,         0.000000000000007105427357601002);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Exbibits,         0.000000000007275957614183426);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Pebibits,         0.000000007450580596923828);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Tebibits,         0.00000762939453125);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Gibibits,         0.0078125);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Mebibits,         8.0);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Kibibits,      8192.0);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Yottabytes,       0.000000000000000001048576);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Zettabytes,       0.000000000000001048576);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Exabytes,         0.000000000001048576);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Petabytes,        0.000000001048576);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Terabytes,        0.000001048576);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Gigabytes,        0.001048576);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Megabytes,        1.048576);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Kilobytes,     1048.576);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Bytes,      1048576.0);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Yottabits,        0.000000000000000008388608);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Zettabits,        0.000000000000008388608);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Exabits,          0.000000000008388608);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Petabits,         0.000000008388608);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Terabits,         0.000008388608);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Gigabits,         0.008388608);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Megabits,         8.388608);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Kilobits,      8388.608);
                convertToTest.run(DataSize.mebibytes(1), DataSizeUnit.Bits,       8388608.0);

                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Yobibytes,     0.0000000000000000000008470329472543003);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Zebibytes,     0.0000000000000000008673617379884035);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Exbibytes,     0.0000000000000008881784197001252);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Pebibytes,     0.0000000000009094947017729282);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Tebibytes,     0.0000000009313225746154785);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Gibibytes,     0.00000095367431640625);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Mebibytes,     0.0009765625);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Kibibytes,     1.0);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Yobibits,      0.000000000000000000006776263578034403);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Zebibits,      0.000000000000000006938893903907228);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Exbibits,      0.000000000000007105427357601002);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Pebibits,      0.000000000007275957614183426);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Tebibits,      0.000000007450580596923828);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Gibibits,      0.00000762939453125);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Mebibits,      0.0078125);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Kibibits,      8.0);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Yottabytes,    0.000000000000000000001024);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Zettabytes,    0.000000000000000001024);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Exabytes,      0.000000000000001024);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Petabytes,     0.000000000001024);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Terabytes,     0.000000001024);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Gigabytes,     0.000001024);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Megabytes,     0.001024);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Kilobytes,     1.024);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Bytes,      1024.0);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Yottabits,     0.000000000000000000008192);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Zettabits,     0.000000000000000008192);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Exabits,       0.000000000000008192);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Petabits,      0.000000000008192);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Terabits,      0.000000008192);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Gigabits,      0.000008192);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Megabits,      0.008192);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Kilobits,      8.192);
                convertToTest.run(DataSize.kibibytes(1), DataSizeUnit.Bits,       8192.0);

                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Yobibytes,                          0.125);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Zebibytes,                        128.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Exbibytes,                     131072.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Pebibytes,                  134217728.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Tebibytes,               137438953472.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Gibibytes,            140737488355328.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Mebibytes,         144115188075855872.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Kibibytes,      147573952589676410000.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Yobibits,                           1.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Zebibits,                        1024.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Exbibits,                     1048576.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Pebibits,                  1073741824.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Tebibits,               1099511627776.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Gibibits,            1125899906842624.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Mebibits,         1152921504606846980.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Kibibits,      1180591620717411300000.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Yottabytes,                         0.15111572745182864);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Zettabytes,                       151.11572745182863);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Exabytes,                      151115.72745182866);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Petabytes,                  151115727.45182866);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Terabytes,               151115727451.82864);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Gigabytes,            151115727451828.66);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Megabytes,         151115727451828640.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Kilobytes,      151115727451828650000.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Bytes,       151115727451828650000000.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Yottabits,                          1.208925819614629);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Zettabits,                       1208.925819614629);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Exabits,                      1208925.8196146293);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Petabits,                  1208925819.6146293);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Terabits,               1208925819614.6292);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Gigabits,            1208925819614629.2);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Megabits,         1208925819614629120.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Kilobits,      1208925819614629200000.0);
                convertToTest.run(DataSize.yobibits(1), DataSizeUnit.Bits,       1208925819614629200000000.0);

                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Yobibytes,                      0.0001220703125);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Zebibytes,                      0.125);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Exbibytes,                    128.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Pebibytes,                 131072.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Tebibytes,              134217728.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Gibibytes,           137438953472.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Mebibytes,        140737488355328.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Kibibytes,     144115188075855872.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Yobibits,                       0.0009765625);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Zebibits,                       1.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Exbibits,                    1024.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Pebibits,                 1048576.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Tebibits,              1073741824.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Gibibits,           1099511627776.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Mebibits,        1125899906842624.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Kibibits,     1152921504606846980.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Yottabytes,                      0.0001475739525896764);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Zettabytes,                      0.1475739525896764);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Exabytes,                      147.57395258967642);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Petabytes,                  147573.95258967642);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Terabytes,               147573952.5896764);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Gigabytes,            147573952589.67642);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Megabytes,         147573952589676.4);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Kilobytes,      147573952589676416.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Bytes,       147573952589676410000.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Yottabits,                       0.0011805916207174112);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Zettabits,                       1.1805916207174112);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Exabits,                      1180.5916207174114);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Petabits,                  1180591.6207174114);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Terabits,               1180591620.7174113);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Gigabits,            1180591620717.4114);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Megabits,         1180591620717411.2);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Kilobits,      1180591620717411330.0);
                convertToTest.run(DataSize.zebibits(1), DataSizeUnit.Bits,       1180591620717411300000.0);

                convertToTest.run(DataSize.exbibits(1), DataSizeUnit.Yobibytes,                    0.00000011920928955078125);
                convertToTest.run(DataSize.exbibits(1), DataSizeUnit.Zebibytes,                    0.0001220703125);
                convertToTest.run(DataSize.exbibits(1), DataSizeUnit.Exbibytes,                    0.125);
                convertToTest.run(DataSize.exbibits(1), DataSizeUnit.Pebibytes,                  128.0);
                convertToTest.run(DataSize.exbibits(1), DataSizeUnit.Tebibytes,               131072.0);
                convertToTest.run(DataSize.exbibits(1), DataSizeUnit.Gibibytes,            134217728.0);
            ...
            {
                final Action3<DataSize,Object,Boolean> equalsTest = (DataSize dataSize, Object rhs, Boolean expected) ->
                {
                    runner.test("with " + English.andList(dataSize, rhs), (Test test) ->
                    {
                        test.assertEqual(expected, dataSize.equals(rhs));
                    });
                };

                equalsTest.run(DataSize.megabytes(1), null, false);
                equalsTest.run(DataSize.megabytes(1), "hello", false);
                equalsTest.run(DataSize.megabytes(1), DataSize.megabytes(1), true);
                equalsTest.run(DataSize.megabytes(1), DataSize.kilobytes(1000), true);
            ...
            runner.testGroup("equals(DataSize)", () ->
            {
                final Action3<DataSize,DataSize,Boolean> equalsTest = (DataSize dataSize, DataSize rhs, Boolean expected) ->
                {
                    runner.test("with " + English.andList(dataSize, rhs), (Test test) ->
                    {
                        test.assertEqual(expected, dataSize.equals(rhs));
