...
public interface JavaLinkedHashMapTests
{
    public static void test(TestRunner runner)
    {
        runner.testGroup(JavaLinkedHashMap.class, () ->
        {
            MutableMapTests.test(runner, JavaLinkedHashMap::create, false, false);
        });
        ...
        runner.testGroup("set(TKey,TValue)", () ->
        {
            runner.testGroup("speed tests", () ->
            {
                final Action2<Integer,Duration> noConflictsSpeedTest = (Integer targetCount, Duration expectedDuration) ->
                {
                    ...
                    {
                        final MutableMap<Integer,Boolean> map = JavaLinkedHashMap.create();
