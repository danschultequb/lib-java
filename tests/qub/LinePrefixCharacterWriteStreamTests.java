...
public interface LinePrefixCharacterWriteStreamTests
{
    static void test(TestRunner runner)
    {
        runner.testGroup(LinePrefixCharacterWriteStream.class, () ->
        {
            runner.testGroup("create(CharacterWriteStream)", () ->
            {
                ...
                runner.test("with disposed", (Test test) ->
                {
                    ...
                    final LinePrefixCharacterWriteStream stream = LinePrefixCharacterWriteStream.create(innerStream);
            ...
            runner.testGroup("setLinePrefix(Function0<String>)", () ->
            {
                ...
                runner.test("with function that returns null", (Test test) ->
                {
                    ...
                    final LinePrefixCharacterWriteStream setLinePrefixResult = stream.setLinePrefix(() -> (String)null);
                ...
                runner.test("with function that returns empty", (Test test) ->
                {
                    ...
                    final LinePrefixCharacterWriteStream setLinePrefixResult = stream.setLinePrefix(() -> "");
                    test.assertSame(stream, setLinePrefixResult);
                ...
                runner.test("with function that returns non-empty", (Test test) ->
                {
                    ...
                    final LinePrefixCharacterWriteStream setLinePrefixResult = stream.setLinePrefix(() -> "hello");
                    test.assertSame(stream, setLinePrefixResult);
                ...
                runner.test("with function that returns a different value each time it is called", (Test test) ->
                {
                    ...
                    final LinePrefixCharacterWriteStream setLinePrefixResult = stream.setLinePrefix(() -> value.increment().toString());
                    test.assertSame(stream, setLinePrefixResult);
            ...
            runner.testGroup("setNewLine(char)", () ->
            {
                final Action1<Character> setNewLineTest = (Character newLine) ->
                {
                    runner.test("with " + Characters.escapeAndQuote(newLine), (Test test) ->
                    {
                        ...
                        final LinePrefixCharacterWriteStream setNewLineResult = stream.setNewLine(newLine);
